    ...
    public partial class PortfolioDataSet : global::System.Data.DataSet {
        ...
        public partial class portfolioRow : global::System.Data.DataRow {
            ...
            public string company {
                get {
                    return ((string)(this[this.tableportfolio.companyColumn]));
                }
                set {
                    this[this.tableportfolio.companyColumn] = value;
                }
            }
            ...
            public int shares {
                get {
                    return ((int)(this[this.tableportfolio.sharesColumn]));
                }
                set {
                    this[this.tableportfolio.sharesColumn] = value;
                }
            }
            ...
            public decimal total {
                get {
                    return ((decimal)(this[this.tableportfolio.totalColumn]));
                }
                set {
                    this[this.tableportfolio.totalColumn] = value;
                }
            }
        }
...
namespace StockMarket.PortfolioDataSetTableAdapters {
...
SELECT Id, symbol, company, shares, price, total FROM portfolio WHERE (Id = @Id)";
        ...
        public virtual int Fill(PortfolioDataSet.portfolioDataTable dataTable) {
        ...
        public virtual PortfolioDataSet.portfolioDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PortfolioDataSet.portfolioDataTable dataTable = new PortfolioDataSet.portfolioDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PortfolioDataSet.portfolioDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_symbol, string Original_company, int Original_shares, decimal Original_price, decimal Original_total) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_shares));
        ...
        public virtual int Insert(int Id, string symbol, string company, int shares, decimal price, decimal total) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((int)(shares));
        ...
        public virtual int Update(int Id, string symbol, string company, int shares, decimal price, decimal total, int Original_Id, string Original_symbol, string Original_company, int Original_shares, decimal Original_price, decimal Original_total) {
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_shares));
